    ...
    async add(username) {
        try {
            ...
            if (user.login === undefined) {
                ...
                throw new Error("Digite um usuário para Cadastrar!");
            }
...
export class FavoritesView extends Favorites {
    ...
    onadd() {
        const addButton = this.root.querySelector("#favoriteButton");
        addButton.onclick = () => {
        ...
        const inputSearchEnter = document.querySelector("#inputSearch");
        inputSearchEnter.addEventListener("keydown", (e) => {
            if (e.key == "Enter") {
                this.add(inputSearchEnter.value);
                inputSearchEnter.value = "";
            }
        });
    }
    ...
    createRow() {
        ...
        tr.innerHTML = `<td class="user">
                            <img
                                src="https://github.com/wiltonmartinsdev.png"
                                alt="imagem de perfil github"
                            />

                            <a href="https://github.com/wiltonmartinsdev" target="_blank">
                                <p>Wilton Martins</p>
                                <span>/wiltonmartins</span>
                            </a>
                        </td>

                        <td id="repositories">54</td>

                        <td id="followers">65</td>

                        <td id="remove" class="remove">
    ...
    emptyTable() {
        if (this.entries.length === 0) {
            const tr = document.createElement("tr");
            tr.classList.add("emptyTable")
            tr.innerHTML = `<td class="emptyTable">
            <svg
                width="132"
                height="125"
                viewBox="0 0 57 54"
